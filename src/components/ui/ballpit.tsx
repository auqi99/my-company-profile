...
/* =========================================================
   ...
   const XConfig = {
    count: 200,
    colors: [0xff0000, 0x00ff00, 0x0000ff, 0xffff00, 0xff00ff, 0x00ffff], // Warna-warni
    ...
    wallBounce: 0.95,
    maxVelocity: 0.15,
    maxX: 10, // Perbesar area horizontal (X-axis)
    maxY: 10, // Perbesar area vertikal (Y-axis)
    maxZ: 5,  // Perbesar area kedalaman (Z-axis)
  ...
  setColors(colors: number[]) {
    if (Array.isArray(colors) && colors.length > 1) {
      ...
      for (let idx = 0; idx < this.count; idx++) {
        const color = colorUtils.getColorAt(Math.random()); // Warna acak
